    ...
    try:
        ...
        created = await provider.create_reservation(
            CreateReservationRequest(
                venue_id=RESTAURANT_ID,
                guest=GuestInput(
                    full_name="Compliance Test Guest",
                    phone="+61000000003",
                    email=None,
                ),
                party_size=2,
                ...
                special_requests="Created by compliance test",
                tags=[],
                channel=Channel.CONCIERGE_CHAT,
        ...
        updated = await provider.update_reservation(
            UpdateReservationRequest(
                ...
                changes=ReservationChanges(
                    ...
                    party_size=3,
                    special_requests="Updated by compliance test",
                ),
                client_token=IdempotencyKey.generate(),
            )
        )
        ...
        assert updated.special_requests == "Updated by compliance test"
