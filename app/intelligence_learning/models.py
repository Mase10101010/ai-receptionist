...
class RestaurantLearningProfile(Base):
    ...
    accepted_move_complexity_average: Mapped[
        float | None
    ] = mapped_column(
        Float,
        nullable=True,
    ...
    accepted_move_complexity_samples: Mapped[
        int
    ] = mapped_column(
        Integer,
        nullable=False,
    ...
    dismissed_move_complexity_average: Mapped[
        float | None
    ] = mapped_column(
        Float,
        nullable=True,
    ...
    dismissed_move_complexity_samples: Mapped[
        int
    ] = mapped_column(
        Integer,
        nullable=False,
