        ...
        *,
        ...
        return {
            "suggestions_created": int(
                row.suggestions_created
                or 0
            ),
            "suggestions_read": int(
                row.suggestions_read
                or 0
            ),
            "suggestions_accepted": int(
                row.suggestions_accepted
                or 0
            ),
            "suggestions_dismissed": int(
                row.suggestions_dismissed
                or 0
            ),
            "suggestions_expired": int(
                row.suggestions_expired
                or 0
            ),

            "average_created_score": (
                float(
                    row.average_created_score
                )
            ...
            "average_moves_dismissed": (
                float(
                    row.average_moves_dismissed
                )
                if row.average_moves_dismissed
                is not None
                else None
            ),
